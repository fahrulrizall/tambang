...
const PagedSearchBargingDetailByNoMVUnused = (data) => {
  let accessToken = Cookies.get("accessToken");
  let _options = {
    headers: {
      contentType: "application/json",
  ...
  return _Get(
    `${process.env.REACT_APP_API_URL}/${endpoint}/list/detail/unused/${data.noBarging}/${data.transhipmentUuid}`,
    {
      params: {
        ...data,
      },
...
export {
  ...
  PagedSearchBargingDetailByNoMVUnused,
};
